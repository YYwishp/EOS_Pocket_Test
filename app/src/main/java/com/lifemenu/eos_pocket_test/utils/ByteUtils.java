...
public class ByteUtils {
	...
	public static int[] LongToBytes(Long n) {
		...
		int[] a = new int[0];
			...
			a = IntStream.range(0, buf.length).map(i -> buf[i] & 0xff).toArray();//为了兼容Android 低版本，更换IntStream包
	...
	public static byte[] writerKey(String key) {
		...
		com.lifemenu.eos_pocket_test.utils.ByteBuffer bf = new com.lifemenu.eos_pocket_test.utils.ByteBuffer();
